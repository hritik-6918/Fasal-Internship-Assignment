...
const ScienceFictionMovies = () => {
    ...
    return (
        <>
            {
                Object.keys(moviePlaylist?.scienceFictionMovies || {}).length <= 0 ?
                    ...
                    </Grid>) : (<PlayListCard moviePlaylist={moviePlaylist?.scienceFictionMovies} playlistName="scienceFictionMovies"/>)
            }
        </>
    );
}
